...
$lang['gvv_compta_title_paiement'] = "Voucher piloot account";
...
$lang['gvv_compta_label_montant'] = 'Transactiebedrag';
...
// Boekingen overdracht
$lang['gvv_transfert_title']            = "Boekingen overdracht";
$lang['gvv_transfert_select_ecriture']  = "Boeking";
$lang['gvv_transfert_add']              = "Toevoegen";
$lang['gvv_transfert_selection']        = "Geselecteerde boekingen";
$lang['gvv_transfert_empty']            = "Geen boeking geselecteerd.";
$lang['gvv_transfert_export']           = "Exporteren";
$lang['gvv_transfert_already_added']    = "Deze boeking staat al in de lijst.";
$lang['gvv_transfert_col_date']         = "Datum";
$lang['gvv_transfert_col_emploi']       = "Debet";
$lang['gvv_transfert_col_ressource']    = "Credit";
$lang['gvv_transfert_col_montant']      = "Bedrag";
$lang['gvv_transfert_col_description']  = "Omschrijving";
$lang['gvv_transfert_col_actions']      = "";
$lang['gvv_transfert_preview_json']     = "JSON bekijken";
$lang['gvv_transfert_preview_modal_title'] = "Voorbeeld van export-JSON";
$lang['gvv_transfert_copy_json']        = "Kopieren naar klembord";
$lang['gvv_transfert_copy_ok']          = "JSON naar klembord gekopieerd.";
$lang['gvv_transfert_copy_ko']          = "Automatisch kopieren mislukt. Kopieer handmatig.";
$lang['gvv_import_title']               = "Boekingen importeren";
$lang['gvv_import_file_label']          = "Exportbestand (.json)";
$lang['gvv_import_submit']              = "Importeren";
$lang['gvv_import_text_label']          = "Of plak de export-JSON";
$lang['gvv_import_text_submit']         = "Importeren vanuit tekstvak";
$lang['gvv_import_success']             = "boekingen succesvol geïmporteerd.";
$lang['gvv_import_error_json']          = "Ongeldig JSON-bestand.";
$lang['gvv_import_error_codec']         = "Rekening niet gevonden voor code";
$lang['gvv_import_error_insert']        = "Invoerfout voor boeking van";
$lang['gvv_import_errors_title']        = "Fouten";
$lang['gvv_import_skipped']             = "Geen boekingen geïmporteerd wegens fouten.";
$lang['gvv_transfert_menu']             = "Boekingen overdracht";
$lang['gvv_import_error_old_format']       = "Bestand is v1.0-formaat — exporteer opnieuw vanuit de broninstantie.";
$lang['gvv_import_error_compte_not_found'] = "Rekening niet gevonden:";
$lang['gvv_import_error_codec_mismatch']   = "Rekeningcode verschilt:";
$lang['gvv_import_error_nom_mismatch']     = "Rekeningnaam verschilt:";
$lang['gvv_import_error_section_mismatch'] = "Beide rekeningen behoren tot verschillende secties:";
$lang['gvv_import_nothing_selected']       = "Geen boeking geselecteerd.";
$lang['gvv_import_preview_title']          = "Importvoorbeeld";
$lang['gvv_import_col_status']             = "Status";
$lang['gvv_import_col_date']              = "Datum";
$lang['gvv_import_col_emploi']             = "Debet";
$lang['gvv_import_col_ressource']          = "Credit";
$lang['gvv_import_col_montant']            = "Bedrag";
$lang['gvv_import_col_description']        = "Omschrijving";
$lang['gvv_import_confirm']                = "Selectie importeren";
$lang['gvv_import_result_title']           = "Importresultaat";
$lang['gvv_import_rollback']               = "Geen boekingen ingevoerd wegens fouten (terugdraaien).";
$lang['gvv_import_select_all']             = "Alles selecteren";
$lang['gvv_import_deselect_all']           = "Alles deselecteren";
$lang['gvv_import_create_missing_account'] = "Ontbrekende rekening aanmaken";
$lang['gvv_import_missing_account_context_msg'] = "Rekening %s %s bestaat niet op deze instantie. Vul het formulier in en bevestig om terug te keren naar import.";
$lang['gvv_import_missing_account_invalid_data'] = "Kan het aanmaken van de rekening niet voorbereiden: onvolledige gegevens.";
