...
$lang['gvv_bar_error_montant_min']       = "The amount must be a whole number of euros, minimum %s.";
$lang['gvv_bar_error_montant_max']       = "The amount must not exceed %s euros.";
...
$lang['gvv_public_bar_error_montant_min'] = "The minimum amount is %s.";
$lang['gvv_public_bar_error_montant_max'] = "The amount must not exceed %s.";
...
$lang['gvv_decouverte_error_email']                 = "Beneficiary email address is required and must be valid.";
...
$lang['gvv_public_decouverte_title']                 = "Payment of your discovery voucher";
$lang['gvv_public_decouverte_button_payer']         = "Proceed to payment on HelloAsso";
$lang['gvv_decouverte_qr_title']                    = "Discovery voucher - HelloAsso card payment";
$lang['gvv_decouverte_qr_intro']                    = "Payment can be completed on this device, or transferred to the card holder with the small QR code.";
$lang['gvv_decouverte_qr_scan_title']               = "Transfer to phone";
$lang['gvv_decouverte_qr_scan_intro']               = "Small QR code: the customer opens the same HelloAsso payment page on their phone.";
$lang['gvv_decouverte_qr_scan_unnecessary']         = "Payment is initiated by the same user: QR transfer is not necessary.";
...
$lang['gvv_decouverte_qr_email_button']             = "Send by email";
$lang['gvv_decouverte_qr_email_modal_title']        = "Transfer payment link by email";
$lang['gvv_decouverte_qr_email_to']                 = "Recipient";
$lang['gvv_decouverte_qr_email_subject']            = "Subject";
$lang['gvv_decouverte_qr_email_body']               = "Message";
$lang['gvv_decouverte_qr_email_send']               = "Send email";
$lang['gvv_decouverte_qr_email_success']            = "Email sent successfully.";
$lang['gvv_decouverte_qr_email_error']              = "Error sending the email.";
$lang['gvv_decouverte_qr_email_invalid_to']         = "Invalid recipient email address.";
$lang['gvv_decouverte_qr_email_default_subject']    = "Link to pay for your discovery flight by card";
$lang['gvv_decouverte_qr_email_default_body']       = "Hello %s,\n\nPlease find below the link to pay for your discovery flight by credit card via HelloAsso:\n\n%s\n\nKind regards,\n%s";
$lang['gvv_decouverte_public_confirm_title']         = "Payment recorded";
$lang['gvv_decouverte_public_confirm_beneficiaire']  = "Recipient";
$lang['gvv_decouverte_public_confirm_montant']       = "Amount";
$lang['gvv_decouverte_public_confirm_email']         = "Email address";
...
$lang['gvv_paiement_generique_error_email']           = "The email address is invalid.";
$lang['gvv_paiement_generique_error_checkout']        = "Unable to create HelloAsso payment. Check configuration and try again.";
$lang['gvv_paiement_generique_error_helloasso_off']   = "HelloAsso is not enabled for this section.";
$lang['gvv_paiement_generique_qr_title']              = "Payment link generated";
$lang['gvv_paiement_generique_qr_intro']              = "Show this QR code to the payer or share the link. The accounting entry will be created automatically upon receipt.";
$lang['gvv_paiement_generique_qr_label_description']  = "Subject";
$lang['gvv_paiement_generique_qr_label_montant']      = "Amount";
$lang['gvv_paiement_generique_qr_label_compte']       = "Account to credit";
$lang['gvv_paiement_generique_qr_link_label']         = "Payment link";
$lang['gvv_paiement_generique_qr_copy']               = "Copy link";
$lang['gvv_paiement_generique_qr_copied']             = "Link copied!";
$lang['gvv_paiement_generique_qr_open']               = "Open HelloAsso";
$lang['gvv_paiement_generique_qr_new']                = "New payment";
$lang['gvv_paiement_generique_cancel']                = "Cancel this request";
$lang['gvv_paiement_generique_cancel_confirm']        = "Cancel this payment request?";
$lang['gvv_paiement_generique_cancel_success']        = "Payment request cancelled.";
$lang['gvv_paiement_generique_confirmed']             = "Payment recorded.";
$lang['gvv_paiement_generique_confirm_email_subject'] = "Payment received: %s";
$lang['gvv_paiement_generique_confirm_email_body']    = "A generic payment has been received via HelloAsso.\n\nDescription: %s\nAmount: %s €\nDate: %s\n\nThe accounting entry has been created automatically.";
// Listing columns and filters
$lang['gvv_liste_filter_type']                        = "Type";
$lang['gvv_liste_col_description']                    = "Description";
$lang['gvv_liste_type_paiement_generique']            = "Generic payment";
