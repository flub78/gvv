...
class DX_Auth {
    ...
    /*
     * Check if the supplied password is the user one
     */
    ...
    function force_password($id, $new_pass) {
        // Load Models
        $this->ci->load->model('dx_auth/users', 'users');
