 ...
 * de facturation.
 */
class Facturation_ulm extends Facturation {
    // Class attributes
    protected $attr;
    ...
    public function facture_rem($vol_id, $date, $debut, $machine, $alt_rem, $vi, $pilote, $payeur, $pourcentage, $name) {
        ...
        if ($vi == 3) {
            ...
            // Remorqué à 500
            $desc = $this->facture_un_500($date, $desc, $pilote, $payeur, $pourcentage, $machine, $vol_id, $free, $name);
        }
     ...
     */
    public function facture_un_500($date, $desc, $pilote, $payeur, $pourcentage, $machine, $vol_id, $free, $name) {
        if ($free) {
            return;
        }
