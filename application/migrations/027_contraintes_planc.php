 ...
 *
 */
class Migration_Contraintes_Planc extends CI_Migration {
	...
	public function up() {
		...
		$sqls = array(
			"ALTER TABLE `comptes`
ADD CONSTRAINT `fk_comptes_planc` FOREIGN KEY (`codec`) REFERENCES `planc` (`pcode`)
ON DELETE RESTRICT ON UPDATE CASCADE",
			"ALTER TABLE `planc` CHANGE `pdesc` `pdesc` VARCHAR(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL"
		);
	...
	public function down() {
		...
		$sqls = array(
			...
			"ALTER TABLE `comptes` DROP FOREIGN KEY `fk_comptes_planc`",
			"ALTER TABLE `planc` CHANGE `pdesc` `pdesc` VARCHAR(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL"
		);
