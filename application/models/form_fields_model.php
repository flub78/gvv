...
class Form_fields_model extends CI_Model {
    ...
    private $allowed_field_types = array(
        ...
        'select', 'radio', 'checkbox', 'file', 'signature', 'subform'
    );
    ...
    public function create_field(array $data) {
        ...
        $row = array(
            ...
            'is_identifier'    => !empty($data['is_identifier']) ? 1 : 0,
    ...
    public function update_field($id, array $data) {
        ...
        $update = array(
            ...
            'is_identifier'    => array_key_exists('is_identifier', $data) ? (!empty($data['is_identifier']) ? 1 : 0) : $current['is_identifier'],
