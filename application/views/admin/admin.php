...
echo heading($this->lang->line("gvv_admin_title"), 3);
...
echo heading($this->lang->line("gvv_admin_title_config"), 4);
...
echo heading($this->lang->line("gvv_admin_title_admin"), 4);
$list = array(
...
echo heading($this->lang->line("gvv_admin_title_rights"), 4);
$list = array(
...
$list = array(anchor(controller_url("tests") , $this->lang->line("gvv_admin_menu_ut"), array("class" => "jbutton")),
