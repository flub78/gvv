            ...
            <div class="row g-2">
                <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="sub-card text-center border-primary">
                        ...
                        <div class="card-title"><?= $this->lang->line("gvv_admin_menu_online_payments") ?></div>
                        <div class="card-text text-muted"><?= $this->lang->line("gvv_admin_menu_online_payments_desc") ?></div>
                        <a href="<?= controller_url('paiements_en_ligne/admin_config') ?>" class="btn btn-primary btn-sm">
