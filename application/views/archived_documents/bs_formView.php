...
<?php
/**
 * Form view for adding/editing documents
 */
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <?php
                $selected_pilot = isset($pilot_login) ? $pilot_login : $this->dx_auth->get_username();
                echo form_dropdown('pilot_login', $pilot_selector, $selected_pilot, 'class="form-select" id="pilot_login"');
                ?>
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                ...
                <small class="text-muted">Optionnel, pour les documents de section</small>
            </div>
        </div>
        <?php else: ?>
