<!-- VIEW: application/views/authorization/bs_select_role.php -->
<?php
/**
...
<div id="body" class="body container-fluid">
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <form method="get" action="<?= site_url('authorization/role_permissions') ?>" id="selectRoleForm">
                <div class="mb-3">
...
$(document).ready(function() {
    $('#selectRoleForm').on('submit', function(e) {
        ...
        if (roleId) {
            window.location.href = '<?= site_url('authorization/role_permissions') ?>/' + roleId;
        }
    });
});
</script>
