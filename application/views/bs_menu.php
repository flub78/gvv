...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark pb-3 sticky-top">
    <div class="container-fluid">
      ...
      <a class="navbar-brand btn btn-sm" href="<?= controller_url("welcome") ?>" style="background-color:<?= htmlspecialchars($banner_color, ENT_QUOTES, 'UTF-8') ?>;border-color:<?= htmlspecialchars($banner_color, ENT_QUOTES, 'UTF-8') ?>;color:white;"><i class="fa fa-home me-1"></i>Accueil GVV</a>
        ...
        <div class="collapse navbar-collapse" id="mynavbar">
          <ul class="navbar-nav me-auto">
            ...
            <?php if (has_role('ca') || has_role('backup_db')) : ?>
                    ...
                    <li><a class="dropdown-item" href="#"><i class="fas fa-plane-departure text-info"></i> <?= translation("gvv_menu_vols_decouverte") ?>&raquo;</a>
                      <ul class="submenu dropdown-menu">
                        ...
                        <?php if (has_vd_role()) : ?>
                          ...
                          <li><a class="dropdown-item" href="<?= controller_url("vols_decouverte_looks") ?>"><i class="fas fa-cog text-secondary"></i> <?= translation("gvv_menu_vd_looks") ?></a></li>
                          <?php endif; ?>
              ...
              <?php if (has_role('ca') || has_role('bureau') || has_role('admin')) : ?>
              ...
              <?php if (has_role('tresorier')) : ?>
                ...
                <li><a class="dropdown-item" href="#"><i class="fas fa-calculator text-success"></i> <?= translation("gvv_menu_admin_accounting") ?> &raquo;</a>
                  <ul class="submenu dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="<?= controller_url("compta/transfert") ?>"><i class="fas fa-exchange-alt text-warning"></i> <?= translation("gvv_transfert_menu") ?></a></li>
                    <li><a class="dropdown-item" href="<?= controller_url("compta/import_ecritures") ?>"><i class="fas fa-file-import text-warning"></i> <?= translation("gvv_import_title") ?></a></li>
                    <?php endif; ?>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <?php if (has_role('club-admin')) : ?>
              ...
              <li><a class="dropdown-item" href="<?= controller_url("cartes_membre/generation") ?>"><i class="fas fa-id-badge text-primary"></i> <?= translation("gvv_menu_cartes_membre") ?></a></li>
