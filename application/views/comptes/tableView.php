...
$footer = array();
$footer[] = array('', $this->lang->line("comptes_label_totals"), euro($total['debit']), euro($total['credit']), euro($total['solde_debit']), euro($total['solde_credit']), '', '');
if ($detail) {
	$footer[] = array('', $this->lang->line("comptes_label_totals_balance"), euro($total['solde_debit']), euro($total['solde_credit']), '', '');
}
$footer[] = array('', $this->lang->line("comptes_label_balance"), $solde_deb, $solde_cred, '', '');
