<!-- VIEW: application/views/configuration/bs_tableView.php -->
<?php
...
$attrs = array(
    ...
    'fields' => array('cle', 'valeur', 'file', 'lang', 'categorie', 'club', 'description'),
...
echo '<div class="mb-3">'
    . '<a href="' . site_url('configuration/create') . '" class="btn btn-sm btn-success">'
