<!-- VIEW: application/views/email_lists/addresses.php -->
<?php
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            ...
            <small class="form-text text-muted">
                <span id="addressCount"><?= isset($address_count) ? $address_count : 0 ?></span> <?= $this->lang->line('mail_addresses_count') ?>
            </small>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#selection').change(function() {
        var listId = $(this).val();
        if (listId) {
            $.post('<?= controller_url("email_lists/ajax_get_addresses") ?>', {
                list_id: listId
            }, function(data) {
