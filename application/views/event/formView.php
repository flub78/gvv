...
echo '<div id="body" class="body ui-widget-content">';
	...
	echo heading($this->lang->line("gvv_events_title"), 3);
	...
	$table [$row][] = dropdown_field('event_type_flight', $event_type_flight, 
			$this->lang->line("gvv_events_type_selector"), "onchange=get_plane_selector(this);");
