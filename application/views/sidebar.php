...
if (ENVIRONMENT == 'development') {
	$submenu[] = array ('label' => "Licences", 'url' => base_url() . 'index.php/event/licences', 'role' => 'admin');
}
...
$submenu = array (
                array ('label' => $this->lang->line("gvv_button_help"), 'url' => "http://projets.developpez.com/projects/gvv/wiki/Documentation_utilisateur", 'role' => ''),
