<!-- VIEW: application/views/types_ticket/bs_formView.php -->
<?php
/**
 ...
 *    
 * Formulaire de saisie des types de ticket
 * @package vues
 */
...
if ($action == CREATION) {
	echo heading("Nouveau type de ticket", 3);
} elseif ($action == MODIFICATION) {
	echo heading("Modification d'un type de ticket", 3);
} else {
	echo heading("Visualisation d'un type de ticket", 3);
}
