<!-- VIEW: application/views/vols_decouverte/bs_formMenu.php -->
<?php
...
<?php if (!$cancelled && !$expired && !$date_vol && (isset($has_pilot_rights) ? $has_pilot_rights : $has_modification_rights)): ?>
