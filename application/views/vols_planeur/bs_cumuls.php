<!-- VIEW: application/views/vols_planeur/bs_cumuls.php -->
<?php
/**
...
// echo heading('<div id="titre">' . $this->lang->line($title_key) . "</div>", 3);
$titre = $this->lang->line($title_key);
echo form_hidden('titre', $titre, '"id"="titre"');
...
<script type="text/javascript" src="<?php echo js_url('cumul_vols'); ?>"></script>
