<!-- VIEW: application/views/vols_planeur/bs_statistic.php -->
<?php
...
echo '<div id="body" class="body container-fluid ui-widget-content ">';

echo heading("gvv_vols_planeur_title_statistic", 3);
