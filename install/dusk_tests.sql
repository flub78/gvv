...
CREATE TABLE `reports` (
  ...
  PRIMARY KEY (`nom`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Rapports définis par l''utilisateur';
...
CREATE TABLE `type_ticket` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Type de tickets';
...
CREATE TABLE `tickets` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=522 DEFAULT CHARSET=utf8 COMMENT='Tickets de remorqué ou treuillé';
...
CREATE TABLE `categorie` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Catégorie d écritures pour comptabilité analytique';
...
INSERT INTO planc (`pcode`, `pdesc`) VALUES ('164', 'Emprunts auprès des établissements de crédit');
...
INSERT INTO membres (`mlogin`, `mnom`, `mprenom`, `memail`, `memailparent`, `madresse`, `cp`, `ville`, `pays`, `mtelf`, `mtelm`, `mdaten`, `m25ans`, `mlieun`, `msexe`, `mniveaux`, `macces`, `club`, `ext`, `actif`, `username`, `photo`, `compte`, `comment`, `trigramme`, `categorie`, `profession`, `inst_glider`, `inst_airplane`, `licfed`) VALUES ('abraracourcix', 'Le Gaulois', 'Abraracourcix', 'abraracourcix@flub78.net', '', '1 rue des menhirs', '0', '', '', '', '', NULL, '0', '0', 'M', '8192', '0', '0', '0', '1', '0', '', '0', 'abraracourcix', '', '0', '', '', '', '0');
INSERT INTO membres (`mlogin`, `mnom`, `mprenom`, `memail`, `memailparent`, `madresse`, `cp`, `ville`, `pays`, `mtelf`, `mtelm`, `mdaten`, `m25ans`, `mlieun`, `msexe`, `mniveaux`, `macces`, `club`, `ext`, `actif`, `username`, `photo`, `compte`, `comment`, `trigramme`, `categorie`, `profession`, `inst_glider`, `inst_airplane`, `licfed`) VALUES ('asterix', 'Le Gaulois', 'Asterix', 'asterix@flub78.net', '', '1 rue des menhirs', '0', '', '', '', '', NULL, '0', '0', 'M', '524288', '0', '0', '0', '1', '0', '', '0', 'asterix', '', '0', '', '', '', '0');
INSERT INTO membres (`mlogin`, `mnom`, `mprenom`, `memail`, `memailparent`, `madresse`, `cp`, `ville`, `pays`, `mtelf`, `mtelm`, `mdaten`, `m25ans`, `mlieun`, `msexe`, `mniveaux`, `macces`, `club`, `ext`, `actif`, `username`, `photo`, `compte`, `comment`, `trigramme`, `categorie`, `profession`, `inst_glider`, `inst_airplane`, `licfed`) VALUES ('goudurix', 'Le Gaulois', 'Goudurix', 'goudurix@flub78.net', '', '1 rue des menhirs', '0', '', '', '', '', NULL, '0', '0', 'M', '0', '0', '0', '0', '1', '0', '', '0', 'goudurix', '', '0', '', '', '', '0');
INSERT INTO membres (`mlogin`, `mnom`, `mprenom`, `memail`, `memailparent`, `madresse`, `cp`, `ville`, `pays`, `mtelf`, `mtelm`, `mdaten`, `m25ans`, `mlieun`, `msexe`, `mniveaux`, `macces`, `club`, `ext`, `actif`, `username`, `photo`, `compte`, `comment`, `trigramme`, `categorie`, `profession`, `inst_glider`, `inst_airplane`, `licfed`) VALUES ('panoramix', 'Le Gaulois', 'Panoramix', 'panoramix@flub78.net', '', '1 rue des menhirs', '0', '', '', '', '', NULL, '0', '0', 'M', '491520', '0', '0', '0', '1', '0', '', '0', 'panoramix', '', '0', '', '', '', '0');
...
CREATE TABLE `licences` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=228 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('292', 'Immobilisations', '', 'Immobilisations', '215', '1', '0.00', '0.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('293', 'Fonds associatifs', '', 'Fonds associatifs', '102', '1', '0.00', '0.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('294', 'Banque', '', 'Banque', '512', '1', '850.47', '152.63', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('295', 'Emprunt', '', 'Emprunt', '164', '1', '0.00', '0.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('296', 'Atelier de la Somme', '', 'Fournisseur', '401', '1', '350.00', '350.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('297', 'Frais de bureau', '', 'Frais de bureau', '606', '1', '25.50', '0.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('298', 'Essence plus huile', '', 'Essence plus huile', '606', '1', '125.50', '0.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('299', 'Entretien', '', 'Entretien', '615', '1', '350.00', '350.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('300', 'Assurances', '', 'Assurances', '616', '1', '0.00', '0.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('301', 'Heures de vol planeur', '', 'Heures de vol planeur', '706', '1', '0.00', '0.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('302', 'Remorqués', '', 'Remorqués', '706', '1', '0.00', '23.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('303', 'Heures de vol ULM', '', 'Heures de vol ULM', '706', '1', '0.00', '51.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('304', 'Subventions', '', 'Subventions', '74', '1', '0.00', '500.00', 'testadmin', '0');
INSERT INTO comptes (`id`, `nom`, `pilote`, `desc`, `codec`, `actif`, `debit`, `credit`, `saisie_par`, `club`) VALUES ('305', 'Le Gaulois Asterix', 'asterix', 'Compte pilote', '411', '1', '51.00', '100.00', 'testadmin', '0');
...
CREATE TABLE `ecritures` (
  ...
  KEY `compte2` (`compte2`)
) ENGINE=InnoDB AUTO_INCREMENT=8871 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8861', '2023', '2023-06-17', '2023-06-17', '294', '305', '100.00', 'Avance sur vols', '0', 'AV-1', 'testadmin', '0', '0', '0', '0', '0.00', '0');
INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8862', '2023', '2023-06-17', '2023-06-17', '294', '306', '250.47', 'Avance avec décimals', '0', 'Petites pièces', 'testadmin', '0', '0', '0', '0', '0.00', '0');
INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8863', '2023', '2023-06-17', '2023-06-17', '306', '302', '23.00', 'Facturation manuelle de remorqués', '0', 'Facture d\'un autre club', 'testadmin', '0', '0', '0', '0', '0.00', '0');
INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8864', '2023', '2023-06-17', '2023-06-17', '294', '304', '500.00', 'Subvention d\'aide à la formation', '0', 'Relevé CDN', 'testadmin', '0', '0', '0', '0', '0.00', '0');
INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8865', '2023', '2023-06-17', '2023-06-17', '296', '299', '350.00', 'Trop perçu sur facture', '0', 'Facture 4712', 'testadmin', '0', '0', '0', '0', '0.00', '0');
INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8866', '2023', '2023-06-17', '2023-06-17', '298', '294', '125.50', 'Achat d\'essence', '0', 'Chèque 413', 'testadmin', '0', '0', '0', '0', '0.00', '0');
INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8867', '2023', '2023-06-17', '2023-06-17', '297', '307', '25.50', 'Remboursement fournitures de bureau', '0', 'Facture XX78', 'testadmin', '0', '0', '0', '0', '0.00', '0');
INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8868', '2023', '2023-06-17', '2023-06-17', '306', '294', '27.13', 'Remboursement de solde pilote', '0', 'Chèque CDN1027', 'testadmin', '0', '0', '0', '0', '0.00', '0');
INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8869', '2023', '2023-06-17', '2023-06-17', '299', '296', '350.00', 'Utilisation avoir fournisseur', '0', 'Facture 4712', 'testadmin', '0', '0', '0', '0', '0.00', '0');
INSERT INTO ecritures (`id`, `annee_exercise`, `date_creation`, `date_op`, `compte1`, `compte2`, `montant`, `description`, `type`, `num_cheque`, `saisie_par`, `gel`, `club`, `achat`, `quantite`, `prix`, `categorie`) VALUES ('8870', '0', '2023-06-17', '2023-06-17', '305', '303', '51.00', '17/06/2023 100.00 F-JUFA', '0', 'hdv-ULM', 'testadmin', '0', '0', '7217', '0.5', '102.00', '0');
...
INSERT INTO machinesp (`mpconstruc`, `mpmodele`, `mpimmat`, `mpnumc`, `mpnbhdv`, `mpbiplace`, `mpautonome`, `mptreuil`, `mpprive`, `club`, `mprix`, `mprix_forfait`, `mprix_moteur`, `mmax_facturation`, `actif`, `comment`, `horametre_en_minutes`, `fabrication`, `banalise`, `proprio`) VALUES ('Alexander Schleicher', 'Ask21', 'F-CGAA', '', '0.00', '2', '0', '0', '0', '0', 'hdv-planeur', 'hdv-planeur-forfait', 'gratuit', '180', '1', '', '0', '0', '0', '');
INSERT INTO machinesp (`mpconstruc`, `mpmodele`, `mpimmat`, `mpnumc`, `mpnbhdv`, `mpbiplace`, `mpautonome`, `mptreuil`, `mpprive`, `club`, `mprix`, `mprix_forfait`, `mprix_moteur`, `mmax_facturation`, `actif`, `comment`, `horametre_en_minutes`, `fabrication`, `banalise`, `proprio`) VALUES ('Centrair', 'Pégase', 'F-CGAB', 'EG', '0.00', '1', '0', '0', '0', '0', 'hdv-planeur', 'hdv-planeur-forfait', 'gratuit', '180', '1', '', '0', '0', '0', '');
INSERT INTO machinesp (`mpconstruc`, `mpmodele`, `mpimmat`, `mpnumc`, `mpnbhdv`, `mpbiplace`, `mpautonome`, `mptreuil`, `mpprive`, `club`, `mprix`, `mprix_forfait`, `mprix_moteur`, `mmax_facturation`, `actif`, `comment`, `horametre_en_minutes`, `fabrication`, `banalise`, `proprio`) VALUES ('DG', 'DG800', 'F-CGAC', 'AC', '0.00', '1', '0', '0', '0', '0', 'gratuit', 'gratuit', 'gratuit', '180', '1', '', '0', '0', '0', '');
...
INSERT INTO machinesa (`macconstruc`, `macmodele`, `macimmat`, `macnbhdv`, `macplaces`, `macrem`, `maprive`, `club`, `actif`, `comment`, `maprix`, `maprixdc`, `horametre_en_minutes`, `fabrication`) VALUES ('Robin', 'DR400', 'F-GUFB', '0.00', '4', '1', '0', '0', '1', '', 'gratuit', 'gratuit', '0', '0');
INSERT INTO machinesa (`macconstruc`, `macmodele`, `macimmat`, `macnbhdv`, `macplaces`, `macrem`, `maprive`, `club`, `actif`, `comment`, `maprix`, `maprixdc`, `horametre_en_minutes`, `fabrication`) VALUES ('Aeropol', 'Dynamic', 'F-JUFA', '0.00', '2', '1', '0', '0', '1', '', 'hdv-ULM', 'hdv-ULM', '0', '0');
...
INSERT INTO volsa (`vaid`, `vadate`, `vapilid`, `vamacid`, `vacdeb`, `vacfin`, `vaduree`, `vaobs`, `vadc`, `vacategorie`, `varem`, `vanumvi`, `vanbpax`, `vaprixvol`, `vainst`, `valieudeco`, `valieuatt`, `facture`, `payeur`, `pourcentage`, `club`, `gel`, `saisie_par`, `vaatt`, `local`, `nuit`, `reappro`, `essence`, `vahdeb`, `vahfin`) VALUES ('768', '2023-06-17', 'asterix', 'F-JUFA', '100.00', '100.50', '0.50', '', '0', '0', '0', '', '', '0.00', '', '', '', '0', '', '0', '0', '0', 'testadmin', '1', '0', '0', '0', '0', '10.00', '10.30');
...
INSERT INTO tarifs (`id`, `reference`, `date`, `date_fin`, `description`, `prix`, `compte`, `saisie_par`, `club`, `nb_tickets`, `type_ticket`, `public`) VALUES ('80', 'remorqué', '2023-01-01', '2099-12-31', 'Remorqué', '25.00', '302', 'testadmin', '0', '0.00', '0', '1');
INSERT INTO tarifs (`id`, `reference`, `date`, `date_fin`, `description`, `prix`, `compte`, `saisie_par`, `club`, `nb_tickets`, `type_ticket`, `public`) VALUES ('81', 'remorqué-25ans', '2023-01-01', '2099-12-31', 'Remorqué moind de 25 ans', '20.00', '302', 'testadmin', '0', '0.00', '0', '1');
INSERT INTO tarifs (`id`, `reference`, `date`, `date_fin`, `description`, `prix`, `compte`, `saisie_par`, `club`, `nb_tickets`, `type_ticket`, `public`) VALUES ('82', 'Treuillé', '2023-01-01', '2099-12-31', 'Treuillée', '8.00', '302', 'testadmin', '0', '0.00', '0', '1');
INSERT INTO tarifs (`id`, `reference`, `date`, `date_fin`, `description`, `prix`, `compte`, `saisie_par`, `club`, `nb_tickets`, `type_ticket`, `public`) VALUES ('83', 'hdv-planeur', '2023-01-01', '2099-12-31', 'Heure de vol planeur', '30.00', '301', 'testadmin', '0', '0.00', '0', '1');
INSERT INTO tarifs (`id`, `reference`, `date`, `date_fin`, `description`, `prix`, `compte`, `saisie_par`, `club`, `nb_tickets`, `type_ticket`, `public`) VALUES ('84', 'hdv-planeur-forfait', '2023-01-01', '2099-12-31', 'Heure de vol planeur au forfait', '10.00', '301', 'testadmin', '0', '0.00', '0', '1');
INSERT INTO tarifs (`id`, `reference`, `date`, `date_fin`, `description`, `prix`, `compte`, `saisie_par`, `club`, `nb_tickets`, `type_ticket`, `public`) VALUES ('85', 'hdv-ULM', '2023-01-01', '2099-12-31', 'Heure de vol ULM', '102.00', '303', 'testadmin', '0', '0.00', '0', '1');
INSERT INTO tarifs (`id`, `reference`, `date`, `date_fin`, `description`, `prix`, `compte`, `saisie_par`, `club`, `nb_tickets`, `type_ticket`, `public`) VALUES ('86', 'gratuit', '2023-01-01', '2099-12-31', 'non facturé', '0.00', '301', 'testadmin', '0', '0.00', '0', '1');
...
CREATE TABLE `achats` (
  ...
  CONSTRAINT `achats_ibfk_1` FOREIGN KEY (`pilote`) REFERENCES `membres` (`mlogin`),
  CONSTRAINT `achats_ibfk_vol_avion` FOREIGN KEY (`vol_avion`) REFERENCES `volsa` (`vaid`),
  CONSTRAINT `achats_ibfk_vol_planeur` FOREIGN KEY (`vol_planeur`) REFERENCES `volsp` (`vpid`)
) ENGINE=InnoDB AUTO_INCREMENT=7218 DEFAULT CHARSET=utf8 COMMENT='Lignes de factures';

INSERT INTO achats (`id`, `date`, `produit`, `quantite`, `prix`, `description`, `pilote`, `facture`, `saisie_par`, `club`, `machine`, `vol_planeur`, `vol_avion`, `mvt_pompe`, `num_cheque`) VALUES ('7217', '2023-06-17', 'hdv-ULM', '0.50', '102.00', '17/06/2023 100.00 F-JUFA', 'asterix', '0', 'testadmin', '0', 'F-JUFA', NULL, '768', NULL, NULL);
...
INSERT INTO user_profile (`id`, `user_id`, `country`, `website`) VALUES ('120', '118', NULL, NULL);
INSERT INTO user_profile (`id`, `user_id`, `country`, `website`) VALUES ('121', '119', NULL, NULL);
INSERT INTO user_profile (`id`, `user_id`, `country`, `website`) VALUES ('122', '120', NULL, NULL);
INSERT INTO user_profile (`id`, `user_id`, `country`, `website`) VALUES ('123', '121', NULL, NULL);
...
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('15', '1', 'testuser', '$1$wu3.3t2.$Wgk43dHPPi3PTv5atdpnz0', 'testuser@free.fr', '0', NULL, NULL, NULL, NULL, '::1', '2023-06-17 06:34:23', '2011-04-21 15:21:13', '2023-06-17 06:34:23');
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('16', '2', 'testadmin', '$1$uM1.f95.$AnUHH1W/xLS9fxDbt8RPo0', 'frederic.peignot@free.fr', '0', NULL, NULL, NULL, NULL, '::1', '2023-06-18 10:50:18', '2011-04-21 15:21:40', '2023-06-18 10:50:18');
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('58', '7', 'testplanchiste', '$1$DT0.QJ1.$yXqRz6gf/jWC4MzY2D05Y.', 'testplanchiste@free.fr', '0', NULL, NULL, NULL, NULL, '::1', '2023-06-17 06:30:44', '2012-01-25 21:00:23', '2023-06-17 06:30:44');
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('59', '8', 'testca', '$1$9h..cY3.$NzkeKkCoSa2oxL7bQCq4v1', 'testca@free.fr', '0', NULL, NULL, NULL, NULL, '127.0.0.1', '0000-00-00 00:00:00', '2012-01-25 21:00:58', '2014-12-23 21:38:30');
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('60', '3', 'testbureau', '$1$NC0.SN5.$qwnSUxiPbyh6v2JrhA1fH1', 'testbureau@free.fr', '0', NULL, NULL, NULL, NULL, '127.0.0.1', '2012-01-25 21:03:01', '2012-01-25 21:01:36', '2014-12-23 21:39:00');
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('61', '9', 'testtressorier', '$1$KiPMl0ho$/E3NBaprpM5Xcv.z40zjK0', 'testresorier@free.fr', '0', NULL, NULL, NULL, NULL, '127.0.0.1', '0000-00-00 00:00:00', '2012-01-25 21:02:36', '2012-01-25 21:02:36');
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('118', '1', 'asterix', '$1$178.XGif$uv3FdWy4uSb4hURObhQaU1', 'asterix@flub78.net', '0', NULL, NULL, NULL, NULL, '::1', '1900-01-01 00:00:00', '2023-06-17 06:32:07', '2023-06-17 06:32:07');
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('119', '1', 'goudurix', '$1$TgWj4h2S$O.t2stMILkVwqeV5xC/Ky.', 'goudurix@flub78.net', '0', NULL, NULL, NULL, NULL, '::1', '1900-01-01 00:00:00', '2023-06-17 06:32:11', '2023-06-17 06:32:11');
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('120', '1', 'panoramix', '$1$Ih02twmD$BnsuIlxHH62qF41/puKs30', 'panoramix@flub78.net', '0', NULL, NULL, NULL, NULL, '::1', '1900-01-01 00:00:00', '2023-06-17 06:32:16', '2023-06-17 06:32:16');
INSERT INTO users (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES ('121', '1', 'abraracourcix', '$1$B0U6TBCD$Mcx76FTA.ulT.TO.sX2HZ1', 'abraracourcix@flub78.net', '0', NULL, NULL, NULL, NULL, '::1', '1900-01-01 00:00:00', '2023-06-17 06:32:20', '2023-06-17 06:32:20');
