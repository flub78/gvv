...
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (339, 'Report à nouveau créditeur Planeur', 'Report à nouveau créditeur', '110', '1');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (340, 'Report à nouveau débiteur Planeur', 'Report à nouveau débiteur', '119', '1');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (341, "Résultat de l'exercice Planeur (excédent)", "Résultat de l'exercice (excédent)", '120', '1');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (342, "Résultat de l'exercice Planeur (déficit)", "Résultat de l'exercice (déficit)", '129', '1');
...
-- Création des comptes du compte Compte général, General = 4
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (443, 'Fonds associatifs Compte général', 'Fonds associatifs Compte général', '102', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (411, 'Report à nouveau créditeur Compte général', 'Report à nouveau créditeur', '110', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (412, 'Report à nouveau débiteur Compte général', 'Report à nouveau débiteur', '119', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (413, "Résultat de l'exercice Compte général (excédent)", "Résultat de l'exercice (excédent)", '120', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (414, "Résultat de l'exercice Compte général (déficit)", "Résultat de l'exercice (déficit)", '129', '4');

INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (415, 'Salaires', 'Salaires', '421', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (416, 'URSSAF', 'URSSAF', '645', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES (417, 'Taxes atterrissage', 'Taxes atterrissage', '651', '4');

INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES ('418', 'Vols de découverte', 'Vols de découverte', '706', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES ('420', 'Assurances Compte général', 'Assurances Compte général', '616', '4');

INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES ('428', 'Intérêts placements', 'Intérêts placements', '762', '4');

INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES ('429', 'Subventions', 'Subventions', '74', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES ('430', 'Immobilisation Bâtiments', 'Immobilisation Bâtiments', '215', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES ('432', 'Ventes de produits finis', 'Ventes de produits finis', '701', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES ('436', 'Rémunérations du personnel', 'Rémunérations du personnel', '641', '4');
INSERT INTO `comptes` (`id`, `nom`, `desc`, `codec`, `club`) VALUES ('438', 'Compte courant SG Compte Général', 'FR76 3000 XXXX YYYY ZZZZ', '512', '4');
